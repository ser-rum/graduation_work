...
class LoginPage(BasePage):
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.PASSWORD_REPEAT_FORM).send_keys(password)
        self.browser.find_element(*LoginPageLocators.AUTHORIZATION_BUTTON).click()